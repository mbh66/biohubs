...
**Ecological backing.** Money is backed by the health of the substrate it serves (soil carbon, water retention, biodiversity, coordination capacity), not by claims on future extraction. The measurement instruments (BioScore, multi-capital accounting, watershed-yield accounting) are in early development but functional.

**Bioregional issuance.** Money is issued at the bioregional scale by the community whose landscape produces the value the money represents. Multiple bioregions each issue their own currency. An inter-bioregional clearing layer enables trade between them without requiring a single global unit. The bioregion is the primary economic unit, not the sector or the nation-state.
...
**Mycelial network scale.** The global-facing layer: shared methodology and open documentation, the [[archipelago-of-regenerative-projects|Archipelago of Regenerative Projects]], the intellectual and practitioner networks (P2P Foundation, Design School for Regenerating Earth, the bioregional economics discipline) that carry knowledge across bioregional boundaries.
