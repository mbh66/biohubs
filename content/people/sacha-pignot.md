...
Developer of the fractal sovereignty framework, identifying three interlocking scales (hyper-local, bioregional, cosmo-local) that map onto the BioHub's own scale architecture.
