...
**Distinguish operational thesis from research programme.** A bioregional water project should have an operational thesis grounded in peer-reviewed evidence for the specific biome, and can carry a parallel research programme that investigates emerging mechanisms (like bioprecipitation) as citizen-science contributions to the broader scientific question. The two should be kept separate. The operational thesis carries the funding conversations and the verification protocol. The research programme carries its own funding pathway and evidentiary standards.
